    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                const defaultRole = rolesData.length > 0 ? rolesData[0].slug : "";
                setRole(user.roles?.[0]?.slug || defaultRole);
    ...
    if (isLoadingUser) {
        return (
            <div className="flex h-[400px] items-center justify-center">
                <span className="animate-spin mr-2">⏳</span> Loading user data...
            </div>
        );
    }
        ...
        <div className="max-w-3xl mx-auto space-y-6 animate-fade-in">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-0.5">Update user details and assigned role.</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Configure role, status, and reset password if needed.</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        {/* Role selector */}
                        ...
                        <div className="space-y-1.5">
                            <label className="text-sm font-medium">
                                Reset Password <span className="text-muted-foreground text-xs font-normal ml-2">(Leave blank to keep current)</span>
                            </label>
                            <div className="relative">
                                <input
