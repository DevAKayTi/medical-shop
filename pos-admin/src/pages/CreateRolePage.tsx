...
export function CreateRolePage() {
    ...
    useEffect(() => {
        const fetchPermissions = async () => {
            try {
                const data: APIPermission[] = await apiClient("/permissions");
    ...
    const getModuleState = (module: string): "all" | "some" | "none" => {
        ...
        const selectedCount = modulePerms.filter(id => selectedPermIds.includes(id)).length;
        ...
        <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-0.5">Define a new role and its access permissions.</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Set a name, description, and badge colour for this role.</CardDescription>
                    </CardHeader>
